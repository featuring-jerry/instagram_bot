"""
Django settings for instagram_crawling project.
...
SECRET_KEY = 'django-insecure-c+qzu7d=b86lw0i8cr0)p!$8r)&f+1f0zx@4nf8yay6n@ge7#_'
...
ROOT_URLCONF = 'instagram_crawling.urls'
...
WSGI_APPLICATION = 'instagram_crawling.wsgi.application'
